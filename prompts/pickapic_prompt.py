...
CAPTION: "a painting of a ballroom with a chandelier hanging from the ceiling and two persons standing on the floor"
CONTRADICTION: a painting of a bedroom with a chandelier hanging from the ceiling and two persons standing on the floor
MISALIGNMENT: The scene is of a ballroom (CAPTION: ballroom with a chandelier), not a bedroom (CONTRADICTION: bedroom)
MISALIGNMENT TYPE: Object/Noun
...
CONTRADICTION: a cartoon of a mermaid with long black hair in the water
MISALIGNMENT: The hair of the cartoon mermaid is red (CAPTION: red haired mermaid), not black (CONTRADICTION: mermaid with long black hair)
MISALIGNMENT TYPE: Attribute/Adjective
