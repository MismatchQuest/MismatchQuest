...
CAPTION: A room with a chandelier, chairs and pillars.
CONTRADICTION: A room with a fountain, chairs and a table.
MISALIGNMENT: The room has a chandelier (CAPTION: a chandelier) , instead of a fountain (CONTRADICTION: a fountain) .
MISALIGNMENT TYPE: Object/Noun

CAPTION: A view of a mountain range with grass, plants, and trees.
CONTRADICTION: A view of a mountain range with grass, plants, and a lake.
MISALIGNMENT: There are grass, plants and trees in the view (CAPTION: mountain range with grass, plants, and trees) , no lake (CONTRADICTION: mountain range with grass, plants, and a lake.)
MISALIGNMENT TYPE: Object/Noun
"""
...
CAPTION: A woman stands while people sit at a table.
CONTRADICTION: A woman sits while people stand at a table.
MISALIGNMENT: The woman is standing (CAPTION: woman stands), not sitting (CONTRADICTION: woman sits)
MISALIGNMENT TYPE: Action/Verb
"""
